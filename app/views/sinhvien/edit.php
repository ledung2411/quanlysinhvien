...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-gray-800">Sửa thông tin sinh viên</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Thông tin sinh viên: <?= htmlspecialchars($this->sinhvien->HoTen) ?></h6>
        </div>
        <div class="card-body">
            <form method="post" action="index.php?controller=sinhvien&action=edit&id=<?= $this->sinhvien->MaSV ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-text">Mã sinh viên không thể thay đổi.</div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-text">Chỉ chấp nhận các file ảnh (jpg, jpeg, png, gif). Để trống nếu không muốn thay đổi.</div>
